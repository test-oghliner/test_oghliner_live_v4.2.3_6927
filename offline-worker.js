...
(function (self) {
  ...
  var oghliner = self.oghliner = {
    ...
    CACHE_PREFIX: 'offline-cache:test-oghliner/test_oghliner_live_v4.2.3_6927:' + (self.registration ? self.registration.scope : '') + ':',

    // This is the unique name for the cache controlled by this version of the worker.
    get CACHE_NAME() {
      return this.CACHE_PREFIX + '1794289bae9010869e06d32f585f7e406ececb6f';
    },
    ...
    RESOURCES: [
      ...
      './index.html', // e59c3620506f8cbe416936270315bed1ac711915
